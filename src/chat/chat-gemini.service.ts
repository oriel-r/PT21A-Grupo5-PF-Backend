...
export class ChatServiceGemini {
  ...
  private async getAIResponse( context: string[]) {
    ...
    Si bien este es el contexto actual no es necesario que me respondas todo cada vez que te pregunto algo, responde la ultima pregunta y solo algo del contexto si te lo indico, no me respondas como bot
    `;
